...
func (d *Daemon) createEndpoint(ctx context.Context, owner regeneration.Owner, epTemplate *models.EndpointChangeRequest) (*endpoint.Endpoint, int, error) {
	...
	ep, err := endpoint.NewEndpointFromChangeModel(d.ctx, owner, d, d.ipcache, d.l7Proxy, d.identityAllocator, epTemplate, d.legacyMetrics)
	if err != nil {
...
func (h *patchEndpointID) Handle(params PatchEndpointIDParams) middleware.Responder {
	...
	newEp, err2 := endpoint.NewEndpointFromChangeModel(h.d.ctx, h.d, h.d, h.d.ipcache, h.d.l7Proxy, h.d.identityAllocator, epTemplate, h.d.legacyMetrics)
	if err2 != nil {
		r.Error(err2)
