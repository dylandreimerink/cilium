...
// Field 1, Type 2
#define MKR_TEST_RESULT 0b0001010
// Field 2, Type 2
#define MKR_SUITE_LOG 0b0010010

// Field 1, Type 2
#define MKR_TEST_NAME 0b0001010
// Field 2, Type 0
#define MKR_TEST_STATUS 0b0010000
// Field 3, Type 2
#define MKR_TEST_LOG 0b0011010

// Field 1, Type 2
#define MKR_LOG_FMT 0b0001010
// Field 2, Type 1
#define MKR_LOG_ARG 0b0010001
...
({									\
	...
	*(suite_result_cursor++) = MKR_LOG_FMT; 			\
	/* TODO replace size with 2 byte varint */			\
