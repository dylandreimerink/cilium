...
type Node struct {
	...
	RouterIPv6 [16]uint8 `config:"router_ipv6"`
	// IPv4 source address used for SNAT when a Pod talks to itself over a Service.
	ServiceLoopbackIPv4 [4]uint8 `config:"service_loopback_ipv4"`
}

func NewNode() *Node {
	return &Node{[16]uint8{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
