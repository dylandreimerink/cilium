...
// newMapRegistry creates a new MapRegistry and populates it with compile-time
// MapSpecs.
func newMapRegistry(params registryParams) (*MapRegistry, error) {
...
// before the registry starts, otherwise returns [ErrStarted].
//
...
// after the registry has been started, otherwise returns [ErrNotStarted].
//
// Returns [ErrMapNotFound] if no map with the given name exists.
...
// after the registry has started, otherwise returns [ErrNotStarted].
//
