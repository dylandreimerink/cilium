...
func (s *EndpointManagerSuite) SetUpSuite(c *C) {
	...
	s.repo = policy.NewPolicyRepository(idAllocator, nil, nil, metrics.NewLegacyMetrics())
}
...
func (s *EndpointManagerSuite) TestLookup(c *C) {
	...
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), lm, 10, endpoint.StateReady)
	...
	tests := []struct {
		...
		},
		{
			...
			postTestRun: func() {
				...
				ep = endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 10, endpoint.StateReady)
				ep.ID = 0
			},
		},
		{
...
func (s *EndpointManagerSuite) TestLookupCiliumID(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 2, endpoint.StateReady)
	type args struct {
		id uint16
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupContainerID(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 3, endpoint.StateReady)
	type args struct {
		id string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupIPv4(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 4, endpoint.StateReady)
	type args struct {
		ip string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupPodName(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 5, endpoint.StateReady)
	type args struct {
		podName string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestUpdateReferences(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 6, endpoint.StateReady)
	type args struct {
		ep *endpoint.Endpoint
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestRemove(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 7, endpoint.StateReady)
	type args struct {
	}
	type want struct {
	}
...
func (s *EndpointManagerSuite) TestHasGlobalCT(c *C) {
	mgr := NewEndpointManager(&dummyEpSyncher{}, metrics.NewLegacyMetrics())
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), metrics.NewLegacyMetrics(), 1, endpoint.StateReady)
	type want struct {
		result bool
	}
	tests := []struct {
