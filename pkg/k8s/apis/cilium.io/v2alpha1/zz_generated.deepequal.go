...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumBGPVirtualRouterSpec) DeepEqual(other *CiliumBGPVirtualRouterSpec) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumBGPVirtualRouterStatusNode) DeepEqual(other *CiliumBGPVirtualRouterStatusNode) bool {
	if other == nil {
		return false
	}
