...
func (in *CiliumBGPPeeringPolicySpec) DeepCopyInto(out *CiliumBGPPeeringPolicySpec) {
	*out = *in
	...
	if in.VirtualRouters != nil {
		...
		*out = make([]CiliumBGPVirtualRouterSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPRouteAttributes) DeepCopyInto(out *CiliumBGPRouteAttributes) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPRouteAttributes.
func (in *CiliumBGPRouteAttributes) DeepCopy() *CiliumBGPRouteAttributes {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPRouteAttributes)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *CiliumBGPVirtualRouter) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPVirtualRouterList) DeepCopyInto(out *CiliumBGPVirtualRouterList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPVirtualRouterList.
func (in *CiliumBGPVirtualRouterList) DeepCopy() *CiliumBGPVirtualRouterList {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPVirtualRouterList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *CiliumBGPVirtualRouterList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPVirtualRouterSpec) DeepCopyInto(out *CiliumBGPVirtualRouterSpec) {
	*out = *in
	if in.NodeSelector != nil {
		in, out := &in.NodeSelector, &out.NodeSelector
		*out = new(v1.LabelSelector)
	...
	if in.RouteAttributes != nil {
		in, out := &in.RouteAttributes, &out.RouteAttributes
		*out = make([]CiliumBGPRouteAttributes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPVirtualRouterSpec.
func (in *CiliumBGPVirtualRouterSpec) DeepCopy() *CiliumBGPVirtualRouterSpec {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPVirtualRouterSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPVirtualRouterStatus) DeepCopyInto(out *CiliumBGPVirtualRouterStatus) {
	*out = *in
	...
	if in.Nodes != nil {
		...
		*out = make([]CiliumBGPVirtualRouterStatusNode, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPVirtualRouterStatus.
func (in *CiliumBGPVirtualRouterStatus) DeepCopy() *CiliumBGPVirtualRouterStatus {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPVirtualRouterStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPVirtualRouterStatusNode) DeepCopyInto(out *CiliumBGPVirtualRouterStatusNode) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPVirtualRouterStatusNode.
func (in *CiliumBGPVirtualRouterStatusNode) DeepCopy() *CiliumBGPVirtualRouterStatusNode {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPVirtualRouterStatusNode)
	in.DeepCopyInto(out)
	return out
}
